...
return [
  ...
  'debug'  => false,
    ...
    'panel' => [
      ...
      'slug' => 'klinische-praxen-backend'
    ],

    'owebstudio.tinymce' => [
        'apiKey' => 'b9ca4q0vvw3mqmrq0hc4l7wo686t66cj2elkvov49u2jfax2',
        'height' => 750
    ],
    ...
    'medienbaecker.autoresize.quality' => 100,

    // Form Plugin
    'microman.formblock.license' => "mfnVLN3u688jJL25Jy6G7UQA",
    ...
    'sgkirby.commentions.expand' => false, /* Webmention form hide buttom, if true */
    'sgkirby.commentions.allowlinks' => false, /* Allow links in comments, if true */
    'sgkirby.commentions.autolinks' => false,  /* Automatically recognize URLs in comments and turn them into links. Has no effect, if allowlinks is false. */
    'sgkirby.commentions.commentfields' => [
      'name' => false,  // include name field and mark as required
      'email'=> false,  // include email as optional field
