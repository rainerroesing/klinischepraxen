panel.plugin("zero/zero-one", {
  blocks: {
    ...
    team: {
      ...
      template: `
        <figure @dblclick="open" v-if="empty" class="k-block-figure"><button class="k-block-figure-empty k-button" type="button"><span aria-hidden="true" class="k-button-icon k-icon k-icon-file-image"><svg viewBox="0 0 16 16"><use xlink:href="#icon-file-image"></use></svg></span><span class="k-button-text">Neuen Mitarbeiter einsetzen ...</span></button></figure>
        <div @dblclick="open" v-else>
          <k-aspect-ratio
            class="k-block-type-team-image"
            cover="true"
            ratio="1/1"
          >
          ...
          <div class="k-block-type-team-overlay-content">
            <div v-if="text">
              <div class="content-wrapper" v-html="renderedText"/>
            </div>
            <div v-else>
          ...
          <div v-if="content.facharzttitel.length > 0">
            <div class="k-block-type-team-overlay-content">
              {{ content.facharzttitel }}
            </div>
          </div>
          <div v-else></div>
