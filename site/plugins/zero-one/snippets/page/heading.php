...
<?php if ($page->template() == "blog"): ?>
	...
	<div class="" uk-parallax="opacity: 1,0.1; start: 20%; end: 20%;"><?= $page->intro()->kt() ?></div>
	<?php endif ?>
...
<?php else: ?>
	...
	<div class="" style="font-size: 1.4em;" uk-parallax="opacity: 1,0.1; start: 20%; end: 20%;">
		<?= $page->intro()->kt() ?>
	</div>
	<?php endif ?>
