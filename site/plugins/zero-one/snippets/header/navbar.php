    ...
    <?php endif ?>
      ...
      <?php else: ?>
        ...
        <div class="uk-visible uk-visible@m"><a class="uk-button uk-button-primary uk-padding-small uk-padding-remove-vertical" href="#" data-no-swup uk-toggle="target: #offcanvas-flip"><span uk-icon="icon: location; ratio: 1.2"></span> Standorte</a></div>
         <!-- mobile --> 
        <div class="uk-hidden uk-navbar-item tm-menu-animate<?php e($site->children()->listed()->isEmpty(), ' uk-visible', ' uk-visible@m') ?>"><a href="#" data-no-swup uk-icon="icon: menu" uk-toggle="target: #offcanvas-flip"></a></div>
        <?php endif ?>
      <?php endif ?>
      <?php if($site->menuPosition() != "left" && $site->children()->listed()->isNotEmpty()): ?>
        <!-- offset click -->
