            ...
            foreach($images as $image): ?>
                <li class="uk-transition-toggle uk-width-1-1<?= $itemWidth ?>" tabindex="0">
                    <div class="uk-cover-container<?php e($site->siteBorderRadius() == "true", ' uk-border-rounded') ?>">
                        ...
                        <div class="uk-position-bottom uk-position-small uk-overlay uk-overlay-default uk-text-center uk-transition-slide-bottom-small<?php e($site->siteBorderRadius() == "true", ' uk-border-rounded') ?>">
                            ...
                            <h6 class="uk-margin-remove" style="font-size: 14px;"><?= $image->harry() ?></h6>
                        </div>
                        <?php endif ?>
                    </div>
                </li>
