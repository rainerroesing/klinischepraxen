...
<?php else: ?>
<footer role="contentinfo"<?php if($site->animateFooter()->isTrue()): ?> uk-scrollspy="<?php e($site->animateElement() == "divs", 'target: section > div > div > div; ') ?>cls: uk-animation-slide-bottom-small; delay: 100"<?php endif ?>>
<?php endif ?>
...
if($site->enableCookieconsent()->isTrue() && !$page->is(page($privacyPage))): ?>
...
<?php endif ?>
<?php endif ?>
<?php if($site->enableCookieconsent()->isTrue() && !$page->is(page($privacyPage))): ?>
<?php if($site->cachebusting()->isTrue()): ?>
...
<?php endif ?>
<?php endif ?>
<?= js('/assets/js/scripts/rezept.js') ?>
<?= js('/assets/js/scripts/totop.js') ?>
